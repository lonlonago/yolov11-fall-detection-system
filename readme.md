# YOLOv11 Fall Detection System

## Body

YOLOv11 Falling Recognition System Based on Deep Learning YOLOv11's Falling Recognition Detection System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 3 classes,
Name: ['fallen', 'falling', 'stand'],
Dataset quantity: training set 3594 images, validation set 294.
